...
useFrame((state, delta) => (ref.current.rotation.z += (delta * .3)))
...
<mesh
    ...
    <mesh
      ...
      onPointerOver={(event) => hover(true)}
      onPointerOut={(event) => hover(false)}>
      <boxGeometry args={[3., 3., 3., 20, 20, 20 ]} />
      <planeMaterial ref={planeMaterial} side={THREE.DoubleSide} transparent={true}/>
