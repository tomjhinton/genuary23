...
void main() {
  ...
  float cracks = voronoise( 48.0*uv, -1., .25 );
  
  
 vec3 color = vec3(stroke(cracks, .5 * sin(t), .03));

 color = mix(  vec3(.8 + cnoise(uv * 1500. )), color, shape(uv, 4., .7));

//  if(color == vec3(1.)){
//   color = vec3(stroke( voronoise( 24.0*uv, -1., .25 ), .5, .02));
