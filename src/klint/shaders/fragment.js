...
void main() {
  vec2 uv = vUv;
  float t = (uTime *.2) +(length(uv-.5) * 2.) ;
  
  float t2 = (uTime *.05) +length(uv-.5);

  uvRipple(uv, .2);

  vec3 color1 = vec3(91. / 256., 108. / 256., 165. / 256.);
  vec3 color2 = vec3(81. / 256., 80. / 256., 76. / 256.);
  vec3 color3 = vec3(247. / 256., 160. / 256., 10. / 256.);
  vec3 color4 = vec3(250. / 256., 238. / 256., 126. / 256.);
  vec3 color5 = vec3(219. / 256., 99. / 256., 144. / 256.);
  vec3 color6 = vec3(242. / 256., 222. / 256., 221. / 256.);

 vec3 color = mix (color1, color2, shape( uv, 4., .8));
  color = mix (color, color3, shape( uv, 4., .7));
  color = mix (color, color4, shape( uv, 4., .6));
  color = mix (color, color5, shape( uv, 4., .5));
  color = mix (color, color6, shape( uv, 4., .4));
